...
FILENAME="vips-dev-${ARCH}-exp-${VERSION_VIPS}-${VARIANT}.zip"
URL="https://github.com/maxpiva/build-win64-mxe/releases/download/v${VERSION_VIPS}/${FILENAME}"
